...
<html lang="ko" class="no-js" >
   <head>
      ...
      <link href="./css/bookinglogin.css?ver=1" rel="stylesheet" type="text/css">
   </head>
   <body class="biz  ko" >
         ...
         <div class="_view_content" ui-view="content" id="container" >
            <booked-confirm>
               <div class="booking_login">
                  ...
                  <!---->
                  <div >
                     <form name="confirm_form" class="ng-pristine ng-valid" id="form1" action="/reservation/myreservation/" method="post">
                        ...
                        <div class="login_form"> 
                           ...
                           <input type="text" class="login_input ng-pristine ng-untouched ng-valid ng-empty" id="resrv_id" name="resrv_email" aria-invalid="false" placeholder="example@naver.com" title="예매자이메일">  </div>
    ...
    <!-- js -->
	<script>
		const emailInput = document.getElementById('resrv_id');
		const submitButton = document.querySelector('.login_btn.confirm');
		...
		submitButton.addEventListener('click', function(event) {
			...
			if (!isValidEmail(email)) {
				event.preventDefault(); // 이벤트가 서버로 날아가는 것을 방지
