...
<body>
    <div id="container">
        ...
        <div class="ct">
            <div class="ct_wrap">
                <div class="top_title">
                    <a href="/reservation/detail?id=${id}" class="btn_back" title="이전 화면으로 이동"> <i class="fn fn-backward1"></i> </a>
                    <h2><span class="title"></span></h2>
                </div>
                <div class="group_visual">
                    <div class="container_visual" style="width: 414px;">
                        <ul class="visual_img">
                            <li class="item" style="width: 414px;"> <img alt="" class="img_thumb" src="${productInfo.save_file_name}"> <span class="img_bg"></span>
                                <div class="preview_txt">
                                    <h2 class="preview_txt_tit">${productInfo.description}</h2>
                                    
                                    <em class="preview_txt_dsc">₩ ${productInfo.price} ~ </em>
                            </li>
                        </ul>
                    </div>
                </div>
                <div class="section_store_details">
                    <div class="store_details">
                        ...
                        <p class="dsc">
                            ${productInfo.place_name}<br>
                        </p>
                        <h3 class="in_tit">관람시간</h3>
						<p class="dsc">
							<c:forTokens items="${productInfo.opening_hours}" delims="-"
								var="part">
		        ${part}<br>
							</c:forTokens>
						</p>
	...
	<!-- template -->
	<script type="text/html" id="priceList">
		<h3 class="in_tit">요금</h3>
    	<p class="dsc">
    	</p>
	</script>
	
	<script type="text/html" id="priceButton">
	<div class="qty">
		...
		<!-- [D] 수량이 최소 값이 일때 ico_minus3, count_control_input에 disabled 각각 추가, 수량이 최대 값일 때는 ico_plus3에 disabled 추가 -->
			...
			<!-- [D] 금액이 0 이상이면 individual_price에 on_color class 추가 -->
		...
		<div class="qty_info_icon">
			<strong class="product_amount"><span>{price_type_name}</span></strong>
			<strong class="product_price"><span class="price">{price}</span><span class="price_type">원</span></strong>
			<em class="product_dsc">{price}원 ({discount_rate}% 할인가)</em>
		</div>
	</div>
	</script>
	
	<!-- JS -->
	<script src="js/reservationJS.js"></script>
